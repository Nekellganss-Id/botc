...
case 'nulis':
           if (args.length == 0) return reply(`Example: ${prefix + command} Bot | Indo`)
                    ...
                    zero.sendMessage(from, buffer, image, { quoted: ftrol, caption: 'Done Nih....  Jangan Lupa Subscribe Zero YT7'})
                    break
                    case 'delchat':
...
Gak Bisa Jawab Wajib Subsribe Zero YT7`
...
Gak Bisa Jawab Wajib Subscribe Zero YT7`
...
zero.sendMessage(from, asupan, video, {quoted: ftrol, caption: 'Done Nih... Jangan Lupa Subscribe Zero YT7'})
break
case 'asupanfilminfo':
...
contentText: `Done Nih... Jangan Lupa Subscribe Zero YT7`,
footerText: '©Created By Zero YT7',
buttons: but,
headerType: 4
}
...
zero.sendMessage(from, pro, image, {quoted: ftrol, caption: 'Done Nih... Jangan Lupa Subscribe Zero YT7'})
break
...
zero.sendMessage(from, ig, image, {quoted: ftrol, caption: 'Done Nih... Jangan Lupa Subscribe Zero YT7'})
break
case 'igtv':
reply(mess.wait)
...
ig = await getBuffer(ig.result.link)
zero.sendMessage(from, ig, video, {quoted: ftrol, caption: 'Done Nih... Jangan Lupa Subscribe Zero YT7'})
break
case 'tiktoknowm':
reply(mess.wait)
...
await zero.sendMessage(from, hasil, video, {quoted: ftrol, caption : 'Done Nih... Jangan Lupa Subscribe Zero YT7'})
break
case 'tiktokwm':
reply(mess.wait)
if(!q)return reply('Link Video Tiktok Nya Mana ?')
